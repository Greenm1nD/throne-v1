...
export const casinoPage = {
  hero: {
    ...
    imageMobile: '/assets/images/hero-mobile-casino.webp?v=2',
    fallback: '/assets/images/game-roulette.webp',
    video: '/assets/videos/cinemagraph-casino.mp4',
    posY: '62%',
  },
...
export const sportsPage = {
  hero: {
    ...
    video: '/assets/videos/cinemagraph-sports.mp4',
...
export const livePage = {
  hero: {
    ...
    imageMobile: '/assets/images/hero-mobile-live.webp?v=2',
...
export const vipPage = {
  hero: {
    ...
    imageMobile: '/assets/images/hero-mobile-vip.webp?v=2',
    video: '/assets/videos/cinemagraph-vip.mp4',
  ...
  tiers: [
    ...
    },
    {
      ...
      crown: '/assets/images/medallion-crown.webp',
      perks: ['Dedicated VIP Host', 'Highest Cashback', 'Priority Withdrawals'],
    },
    {
      name: 'Sovereign',
      range: '150,001+ XP',
      crown: '/assets/images/medallion-sovereign.webp',
...
export const rewardsPage = {
  hero: {
    ...
    imageMobile: '/assets/images/hero-mobile-rewards.webp?v=2',
    video: '/assets/videos/cinemagraph-rewards.mp4',
...
export const kingdomPage = {
  hero: {
    ...
    imageMobile: '/assets/images/hero-mobile-kingdom.webp?v=2',
    video: '/assets/videos/cinemagraph-kingdom.mp4',
