...
<template>
  ...
  >
    ...
    <button
      type="button"
      class="absolute right-2 top-2 z-30 grid h-11 w-11 place-items-center rounded-full border border-border-gold/20 bg-black/50 backdrop-blur transition-all duration-300 hover:border-gold"
