...
<template>
  <div
    ...
    :class="isChampion ? 'z-10 lg:-mt-3 lg:scale-[1.05]' : 'lg:mt-6'"
    data-reveal
  >
    <!-- Champion outer glow -->
    <div
    ...
    >
      ...
      <!-- Name + winnings -->
      <h3
        class="relative z-10 mt-3 font-display font-bold uppercase tracking-[0.12em]"
        :class="isChampion ? 'text-xl text-gold-gradient sm:text-2xl' : isSilver ? 'text-lg text-[#eef0f5]' : 'text-lg text-[#efd6ad]'"
      >{{ champion.name }}</h3>
