...
/**
 * GoldButton — the brand's primary action.
 * variants:
 *  - solid:   filled champagne-gold (high emphasis)
 *  - outline: hairline gold border on glass (medium)
 *  - ghost:   bare text with gold hover (low)
 */
withDefaults(
  defineProps<{
  ...
  { variant: 'solid', size: 'md', block: false },
)
