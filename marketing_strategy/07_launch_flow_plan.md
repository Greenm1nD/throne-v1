...
**თარიღი:** 2026-08-31 · **ვერსია:** 2 (v1 გადამუშავებულია რევიუს მიხედვით)
...
| **Japan** | 🔴 დახურული | 2025-09-25: პრომო/რეკლამა/აფილიატ-ლინკები/ინფლუენსერები აკრძალულია; NPA-აღსრულება, დაკავებები. **აფილიატ-ტრაფიკიც კრიმინალია** |
| Brazil | 🔴 | SPA-ლიცენზია + ANATEL (უცვლელი) |
| Colombia | 🔴 | Coljuegos (უცვლელი) |
| Bolivia | 🔴/⚪ HOLD | AJ: არაავტორიზებული = უკანონო, სანქციები promoters-ზეც |
...
| **Dominican Rep.** | 🟡 Licensing track | კონკრეტული ონლაინ-ლიცენზია: ლოკალური ოფისი/call-center, .do დომენი, ფასები + **RD$20m bond (≈$330k)** |
...
## გვერდი 5 · 📣 არხები
(v1-ის სტრუქტურა რჩება; ცვლილებები:) Scale-ის ტემპები სცენარზეა მიბმული და არა საერთო · იაპონია ამოღებულია ყველგან · „რა არ მუშაობს" ბლოკს ემატება: **Japan-მიმართული აფილიატ/ინფლუენსერ ტრაფიკი — კრიმინალი 2025-09-25-დან**.
...
\* rev-share GGR-დანაა (COGS), აქ მხოლოდ ფიქსირებული მინიმუმებია · ² counsel-სპრინტი დააზუსტებს — Peru-ს ფასები გამოქვეყნებადია, DR-ის ბონდი ფენა C-შია
...
| DR performance bond (მხოლოდ თუ DR-ს ვიღებთ) | — | +$330k | +$330k |
| **ჯამი C** | **~$80–160k** | **~$225–440k** | **~$460–900k** |

### 6.4 **Total Capital Requirement** (A+B+C+ვენდორები 06-დან)

| | Lean | Base | Aggressive |
|---|---:|---:|---:|
| **სულ საჭირო კაპიტალი წელი-1** | **~$450–600k** | **~$1.0–1.3M** | **~$1.8–2.4M** |
...
3. **DR:** RD$20m ბონდის გამო Dominican Republic-ს ვტოვებთ licensing-track-ზე თუ ვხსნით?
